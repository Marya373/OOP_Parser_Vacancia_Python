...
class HHVacancy(Vacancy):
    """
    Класс работы с вакансией из HeadHunter
    """
...
class SJVacancy(Vacancy):
    """
    Класс работы с вакансией из SuperJob
    """
...
class SJ(API):
    ...
    headers = {
        'X-Api-App-Id':
            'v3.r.137477813.a4083533dafd1b34d5a48f523d4dfb67c921ddd9.4f374c7254ece1a36eb66a66efd67ace0f8892fd'
    }
